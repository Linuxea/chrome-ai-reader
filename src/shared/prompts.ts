...
const ZH: PromptTable = {
  'default': [
    ...
    '',
    '【回答准则】',
    '1. 仅依据文章内容作答，不要编造或用文章之外的知识补充；引用事实、数据时尽量指出其在文中的出处。',
...
const EN: Partial<PromptTable> = {
  'default': [
    ...
    '',
    '[Answering rules]',
    '1. Answer only from the article content. Do not fabricate or supplement with outside knowledge; when citing facts or data, indicate where they appear in the text.',
  ...
  'annotation.system': [
    ...
    '4. Return JSON and nothing else.',
  ].join('\n'),
