const TRANSLATIONS = {
  zh: {
    ...
    'error.imageNeedsVision': '部分图片是在视觉模式下添加的，没有经过 OCR 识别；当前未开启视觉模式，请移除这些图片后重新添加',
  ...
  en: {
    ...
    'error.imageNeedsVision': 'Some images were added in vision mode and have no OCR text. Vision mode is now off — please remove and re-add them',
